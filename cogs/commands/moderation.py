...
class Moderation(commands.Cog):
    ...
    async def _prefix(self, ctx: commands.Context, prefix):
          ...
          await ctx.reply(embed=discord.Embed(description=f"<:greentick:1061709816017453117> | Successfully Changed Prefix For **{ctx.guild.name}**\nNew Prefix for **{ctx.guild.name}** is : `{prefix}`\nUse `{prefix}help` For More info .", color=0x00FFE4))
    ...
    async def softban(self, ctx, member: discord.Member, *, reason=None):
        ...
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Sucessfully soft-banned {member}.", timestamp=ctx.message.created_at)
    ...
    async def purge(self, ctx,amount:int=10):
        ...
        return await ctx.send(f"**<:greentick:1061709816017453117> Deleted {len(deleted)-1} message(s)**")
    ...
    async def startswith(self, ctx, key, amount: int = 10):
        ...
        return await ctx.send(f"**<:greentick:1061709816017453117> Deleted {len(deleted)}/{amount} message(s) which started with the given keyword**")
    ...
    async def endswith(self, ctx, key, amount: int = 10):
        ...
        def check(m):
            ...
            if m.content.endswith(key):
                ...
                return False
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(f"**<:greentick:1061709816017453117> Deleted {len(deleted)}/{amount} message(s) which ended with the given keyword**")
    ...
    async def contains(self, ctx, key, amount: int = 10):
        ...
        def check(m):
            ...
            if key in m.content:
                ...
                return False
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(f"**<:greentick:1061709816017453117> Deleted {len(deleted)}/{amount} message(s) which contained the given keyword**")
    ...
    async def user(self, ctx, user: discord.Member, amount: int = 10):
        ...
        def check(m):
            ...
            if m.author.id == user.id:
                ...
                return False
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(f"**<:greentick:1061709816017453117> Deleted {len(deleted)}/{amount} message(s) which were sent by the mentioned user**")
    ...
    async def invites(self, ctx, amount: int = 10):
        ...
        def check(m):
            ...
            if "discord.gg/" in m.content.lower():
                ...
                return False
        deleted = await ctx.channel.purge(limit=100, check=check)
        return await ctx.send(f"**<:greentick:1061709816017453117> Deleted {len(deleted)}/{amount} message(s) which contained invites**")
    ...
    async def mute(self,ctx, member: discord.Member, minutes: int, reason="None"):
      if member.id == ctx.author.id:
        ...
        await ctx.send(embed=discord.Embed(color=0x00FFE4, description=f"<:greentick:1061709816017453117> | Successfully muted {member.mention} for {minutes}, reason: {reason}"))
    ...
    async def unmute(self,ctx, member: discord.Member):
      if member.id == ctx.author.id:
        ...
        await ctx.send(embed=discord.Embed(color=0x00FFE4, description=f"<:greentick:1061709816017453117> | Successfully Unmuted {member.mention}"))
    ...
    async def kick(self, ctx: commands.Context, member: discord.Member, *, reason=None):
        ...
        if ctx.author.top_role.position > member.top_role.position or member == ctx.guild.owner:
            ...
            hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {member.display_name} has been kicked from this guild, for: {reason}", timestamp=ctx.message.created_at)
    ...
    async def roleallhumans(self,ctx,role:discord.Role):
        hacker = discord.Embed(color=0x00FFE4,description="<:greentick:1061709816017453117> | Adding mentioned role to all members", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        ...
        hacker1 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Added mentioned role to all members", timestamp=ctx.message.created_at)
    ...
    async def roleallbots(self,ctx,role:discord.Role):
        ...
        for h in humans:
            await h.add_roles(role)
        await ctx.reply('**<:greentick:1061709816017453117> | Adding mentioned role to all bots**')

    @commands.command(help ="Removes a role from all the humans.")
    @blacklist_check()
    @commands.has_permissions(administrator=True)
    async def removeallhumans(self,ctx,role:discord.Role):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Removing mentioned role from all members", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.reply(embed=hacker)
        ...
        hacker1 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Removed mentioned role from all members", timestamp=ctx.message.created_at)
        #hacker1.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
    ...
    async def removeallbots(self,ctx,role:discord.Role):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Removing mentioned role from all bots", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
       # hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.reply(embed=hacker)
        ...
        for h in humans:
            await h.remove_roles(role)
        hacker1 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Removed mentioned role from all bots", timestamp=ctx.message.created_at)
        #hacker1.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
       # hacker1.set_thumbnail(url ="https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.reply(embed=hacker1)
    ...
    async def warn(self, ctx, member: discord.Member, * , reason="No Reason Provided!"):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {member.display_name} has been warned for: {reason}", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.send(embed=hacker)
    ...
    async def vcdeafen(self, ctx, user: discord.Member, * , reason=None):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {user.display_name} has been deafened, for: {reason}", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
       # hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.send(embed=hacker)
    ...
    async def vcmute(self, ctx, member: discord.Member, * , reason=None):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {member.display_name} has been muted, for: {reason}", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.send(embed=hacker)
    ...
    async def vcunmute(self, ctx, member: discord.Member):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {member.display_name} has been unmuted.", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.send(embed=hacker)
    ...
    async def vcundeafen(self, ctx, member: discord.Member):
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {member.display_name} has been undeafened.", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
       # hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.send(embed=hacker)
    ...
    async def ban(self, ctx: commands.Context, member: discord.Member, *, reason=None):
        ...
        if ctx.author.top_role.position > member.top_role.position or ctx.author == ctx.guild.owner:
            await member.ban(reason=reason)
            hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {member.display_name} has been successfully banned", timestamp=ctx.message.created_at)
            #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
            hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
            #hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
            await ctx.send(embed=hacker)
    ...
    async def unban(self, ctx, id: int):
        ...
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {user.name} has been successfully unbanned", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
       # hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.send(embed=hacker)
    ...
    async def clone(self, ctx, channel: discord.TextChannel):
        await channel.clone()
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | {channel.name} has been successfully cloned", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.send(embed=hacker)
    ...
    async def changenickname(self, ctx, member: discord.Member, * , nick):
        ...
        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully changed nickname of {member.name}", timestamp=ctx.message.created_at)
        #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
        hacker.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar}")
        #hacker.set_thumbnail(url = "https://cdn.discordapp.com/avatars/977023331117199481/b0270586b291c69b396cd5a24aa11aff.webp?size=2048")
        await ctx.send(embed=hacker)
    ...
    async def _reactions(self, ctx, search=1000):
        ...
        await ctx.message.delete()
        await ctx.send(embed=discord.Embed(description=f"<:greentick:1061709816017453117> | Successfully Removed {total_reactions}.", color=0x00FFE4))
    ...
    async def lock(self,
        ...
        try:
            ...
            await ctx.send(embed=discord.Embed(
                title="Odin | Lockdown",
                description="<:greentick:1061709816017453117> | Successfully locked **%s**" % (channel.mention),
                color=0x00FFE4))
        except:
            await ctx.send(
                embed=discord.Embed(title="Odin | Lockdown",
    ...
    async def unlock(self,
        ...
        try:
            await channel.set_permissions(
                ...
                reason=reason)
            await ctx.send(embed=discord.Embed(
                title="Odin | Unlockdown",
                description="<:greentick:1061709816017453117> | Successfully unlocked **%s**" %
                (channel.mention),
                color=0x00FFE4))
        except:
            await ctx.send(
                embed=discord.Embed(title="Odin | Unlockdown",
