      ...
      try:
                if antiSpam is True:
                 ...
                 #   if not punish_cd_bucket.update_rate_limit():
                      if data["punishment"] == "kick":
                        await message.author.kick(reason=f"Odin | Anti Spam")
                        hacker = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Kicked {message.author} For Spamming")
                      ...
                      if data["punishment"] == "ban":
                        await message.author.ban(reason=f"Odin | Anti Spam")
                        hacker1 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Banned {message.author} For Spamming")
                      ...
                      if data["punishment"] == "none":
                        ...
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Odin | Anti Spam")
                        hacker2 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Muted {message.author} For Spamming")
                ...
                if antiLink is True:
                    ...
                    if invite_matches:
                        ...
                        if data["punishment"] == "kick":
                            await message.author.kick(reason=f"Odin | Anti Discord Invites")
                            hacker3 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Kicked {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "ban":
                            await message.author.ban(reason=f"Odin | Anti Discord Invites", delete_message_days=0)
                            hacker4 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Banned {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "none":
                             now = discord.utils.utcnow()
                             await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Odin | Anti Discord Invites")
                             hacker5 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Muted {message.author} For Sending Discord Server Invites")
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          await message.author.kick(reason="Odin | Anti Link") 
                          hacker6 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Kicked {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "ban":
                          await message.author.ban(reason="Odin | Anti Link")  
                          hacker7 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Banned {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "none":
                          now = discord.utils.utcnow()
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Odin | Anti Link")
                          hacker8 = discord.Embed(color=0x00FFE4,description=f"<:greentick:1061709816017453117> | Successfully Muted {message.author} For Sending Links")
