...
class RootCommand(Feature):
    ...
    async def jsk(self, ctx: ContextA):
        ...
        hacker = discord.Embed( title="Odin Security",color=0x00FFE4,description="\n".join(summary))
        hacker.set_author(name=f"{ctx.author}", icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url =f"{ctx.author.avatar}")
        hacker.set_footer(text="Made By K4MI ⸸#8166", icon_url="https://cdn.discordapp.com/attachments/1046001142057934939/1062786768753147984/odin.png")
