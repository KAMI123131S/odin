...
async def entry(bot: commands.Bot, *args: typing.Any, **kwargs: typing.Any):
  ...
  await discord.utils.maybe_coroutine(bot.load_extension,
                                      'jishaku')  # type: ignore
...
def entrypoint(intents: typing.Iterable[str],
               token: str,
               log_level: str,
  ...
  if log_file:
    log_file_handler: logging.Handler = logging.FileHandler(filename=log_file,
                                                            encoding='utf-8',
                                                            mode='a')
  ...
  default_intents = [
    name for name, value in discord.Intents.default() if value
  ]
  ...
  if discord.version_info >= (2, 0, 0):
    ...
    bot.run(MTA0MDE5NDk0ODQ5NjEwOTU2OQ.GV8d7N.
            cMyvaKXzXJlsN5FEzJFWG5dzs3qXfUbJRIH6DE)  # type: ignore
