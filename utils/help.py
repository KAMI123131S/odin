...
class View(discord.ui.View):
	...
	def hacker(self):
		inv = Buttons(label='Invite Me', style=discord.ButtonStyle.link, url='https://discord.com/oauth2/authorize?client_id=1040194948496109569&scope=bot&permissions=8')
		sup = Buttons(label='Support Server', style=discord.ButtonStyle.link, url='https://discord.gg/painarmyop')
		hack = [inv, sup]
